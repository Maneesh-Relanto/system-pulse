...
const App = {
    ...
    renderIcon(app, size = 'w-16 h-16') {
        ...
        return `
            ...
            <div class="hidden w-full h-full rounded-2xl bg-slate-700 dark:bg-slate-600 flex items-center justify-center text-2xl font-black text-white shadow-lg ring-2 ring-slate-900 dark:ring-slate-300">
                ${firstLetter}
            </div>`;
    },
