...
const App = {
    ...
    renderIcon(app, size = 'w-16 h-16') {
        ...
        if (!logo || logo === 'LETTER_AVATAR' || logo === 'undefined') {
            ...
            return `<div class="w-full h-full rounded-2xl bg-gradient-to-br ${gradient} flex items-center justify-center text-2xl font-black text-white shadow-lg dark:ring-2 dark:ring-slate-300 transform group-hover:scale-110 transition-transform duration-300">
                ${firstLetter}
            </div>`;
        }
        return `
            ...
            <div class="hidden w-full h-full rounded-2xl bg-slate-700 flex items-center justify-center text-2xl font-black text-white shadow-lg dark:ring-2 dark:ring-slate-300">
                ${firstLetter}
            </div>`;
    },
